<div class="idc_checkout_extra_fields hide" id="checkout-form-extra-fields-shipping">
	...
	<div class="form-row idc-checkout-address-field">
		<h3 class="checkout-header"> <?php _e('Phone', 'memberdeck'); ?></h3>
		<label for="address"><?php _e('Phone', 'memberdeck'); ?></label>
		<input type="text" size="20" class="required" name="phone" id="phone" value="<?php echo (isset($address_info['phone']) ? $address_info['phone'] : ''); ?>"/>
	</div>
